...
let website = "/Mpir.NET"

let githubLink = "http://github.com/wezeku/Mpir.NET"

// Specify more information about your project
let info =
  [ "project-name", "Mpir.NET"
    "project-author", "John Reynolds"
    "project-summary", "MPIR for .NET"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Mpir.NET" ]
